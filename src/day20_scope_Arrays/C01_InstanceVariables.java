...
public class C01_InstanceVariables {
    ...
    public static void main(String[] args) {
        //  sayi =10; sayı variable'i static olmadıgı icin main methoddan direk kullanılamaz
        //inctance variable'lara static method'larda ulasabilmek icin obje olusturmamız gerekir
