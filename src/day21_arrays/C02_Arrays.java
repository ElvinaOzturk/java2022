...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        //arrayın icindeki indeksi kullanarak elementlere ulasabilir ve update edebiliriz
        ...
        //Arrayın tamamını yazdırmak istersek
        System.out.println(arr2);  //[I@5b464ce8
                                  //array'ler non-primitive olduklarından direk yazdırmak
        ...
        System.out.println("");
        //array'ı yazdırmak icin Javadaki Arrays clss'indan taString() kullanılır
        ...
        System.out.println(Arrays.toString(arr1));  //[Ali, Esila, Ayse2]
